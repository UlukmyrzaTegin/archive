...
public class HeaderUI extends CustomComponent {
	...
	private VerticalLayout buildVerticalLayout_2() {
		...
		logout.setSource(new ThemeResource("img/infosystema24x24.png"));
		logout.setWidth("24px");
		logout.setHeight("24px");
		verticalLayout_2.addComponent(logout);
		verticalLayout_2.setSizeUndefined();
		verticalLayout_2.setSpacing(true);
		verticalLayout_2.setComponentAlignment(logout, Alignment.MIDDLE_CENTER);
		/*// label_logo
		...
		verticalLayout_2.setComponentAlignment(label_logo, Alignment.MIDDLE_RIGHT);*/
	...
	private VerticalLayout buildVerticalLayout_3() {
		...
		label_name.setValue("Архив файлов");
